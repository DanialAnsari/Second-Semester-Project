 ...
 * @author Sameer
 */
public class VegerinDN implements Decryption {
    
     private String code;
    private StringBuffer decrypted;
    private String decryptedout;
    private String key;
    ...
    public String datain(String code){
        this.code = code;
        return code;
    }
    
    public String procedure(String code,String key){
        ...
        StringBuffer decrypted = new StringBuffer(code.toUpperCase());
        int j;
